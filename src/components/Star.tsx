...
export default function Star({isActive, onClick}: Props) {

    return(
        <button onClick={onClick}>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" fill={ isActive ? "#FCBD00" : "#666666"} width={25} height={25}>
